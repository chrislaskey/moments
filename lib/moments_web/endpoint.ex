defmodule MomentsWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :moments
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :moments
  end
